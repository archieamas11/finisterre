...
export default function AdminMapLayout() {
  ...
  const [selectedPlotForEdit, setSelectedPlotForEdit] = useState<string | null>(
    null
  )
    ...
    <div className='h-full w-full rounded-lg border p-2'>
      ...
      >
        <div className='relative z-1 h-full w-full'>
          ...
          <EditMarkerInstructions
            isVisible={isEditingMarker}
            step={selectedPlotForEdit ? 'edit' : 'select'}
          />
          <MapContainer
