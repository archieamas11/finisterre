  ...
  return (
    <header
      className={cn(
        ...
        {
          'border-border bg-white/60 text-foreground shadow-lg backdrop-blur-lg':
            scrolled,
    ...
    >
      <Link
        to='/'
        className={cn(
          'focus:ring-primary flex items-center gap-2 rounded-md font-bold focus:ring-2 focus:ring-offset-2 focus:outline-none',
          {
            'text-black': scrolled,
            'text-white': !scrolled
          }
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        <Button
          asChild
          type='button'
          className={cn('rounded-full transition-colors bg-transparent', {
            'border-black bg-transparent dark:border-black dark:text-black':
              scrolled,
