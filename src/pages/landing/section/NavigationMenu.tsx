...
const products: NavItem[] = [
  {
    ...
    href: '#products',
    description:
      'Double-depth in-ground burial plot with marble marker and well-manicured grass.'
  },
  {
    icon: LayersIcon,
    ...
    href: '#products',
    description:
      'Best-in-class burial unit crafted with premium concrete and marble markers.'
  },
  {
    icon: BoneIcon,
    ...
    href: '#products',
    description:
      'Concrete repository for bone and ash remains at the upper park level with garden views.'
  },
  {
    icon: Building2Icon,
    title: 'Family Estate',
...
const coreServices: NavItem[] = [
  {
    ...
    href: '#services',
    description:
      'Complete interment services with modern equipment and dignified care.'
  },
  {
    ...
    href: '#services',
    description:
      'Careful relocation of remains including documentation and coordination.'
  },
  {
    icon: ClockIcon,
    ...
    href: '#services',
    description:
      'For fresh, skeletal, and cinerary remains handled with utmost respect.'
  }
]
