      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 text-center sm:px-8">
        ...
        <div className="mb-10 space-y-4">
          <h1 className="text-4xl leading-tight font-bold text-white sm:text-6xl lg:text-7xl">
            <span className="block bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent drop-shadow-lg">Not Your Usual</span>
            <span className="mt-2 block bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 bg-clip-text font-extrabold text-transparent">Memorial Park</span>
          </h1>
