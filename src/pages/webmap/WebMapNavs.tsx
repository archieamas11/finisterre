...
export default function WebMapNavs({ onBack }: { onBack?: () => void }) {
  ...
  return (
    <nav
      className={cn('absolute top-2 right-0 left-0 z-[990] mx-auto flex w-full max-w-full flex-col gap-2 px-3 sm:top-3 sm:px-4 md:top-4 md:px-2 lg:max-w-2xl')}
    ...
    >
      ...
      {/* Controls Row */}
      <WebMapControlsRow context={context} onBack={onBack} />
    </nav>
  )
}
