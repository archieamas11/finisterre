...
export default function WebMapNavs() {
  ...
  return (
    ...
    >
      <Button size="icon" className="rounded-full shadow bg-white/80 hover:bg-white/90 border border-stone-300 dark:bg-primary-foreground dark:hover:bg-stone-800/90 dark:border-stone-700">
