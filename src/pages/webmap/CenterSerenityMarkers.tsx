...
const centerSerenityMarkersData: CustomMarkerData[] = [
  {
    ...
    description:
      'A tranquil centerpiece of Finisterre, ideal for reflection and gatherings. Enjoy panoramic views and peaceful surroundings.',
    marker: {
      type: 'image',
      source:
        'https://res.cloudinary.com/djrkvgfvo/image/upload/v1755253760/Finisterre-Gardenz-columbarium_ewopci.png'
    },
    popupType: 'image'
  }
]
...
export default function CenterSerenityMarkers({
  ...
  return (
    <CustomMarkers
      items={centerSerenityMarkersData}
