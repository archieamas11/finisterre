...
export async function updatePlotCoordinates(
  plot_id: string,
  coordinates: string
) {
...
export async function createPlots(
  data:
    | CreatePlotRequest
    | CreateSerenityLawnRequest
    | CreateMemorialChambersRequest
...
export async function createMemorialChambersPlot(
  data: CreateMemorialChambersRequest
) {
