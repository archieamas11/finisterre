...
export const customerSchema = z.object({
  ...
  contact_number: z.string().regex(/^09\d{9}$/, { message: "Contact number must be a valid PH mobile number (e.g., 09XXXXXXXXX)." }),
  ...
  status: z.enum(["Single", "Married", "Widowed", "Divorced", "Separated"], { message: "Please select a status." }),
});
