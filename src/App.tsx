...
const Bookings = React.lazy(
  () => import('@/pages/admin/bookings/ManageBookings')
)
const AdminDashboard = React.lazy(
  () => import('@/pages/admin/home/AdminDashboard')
)
const UserDashboard = React.lazy(
  () => import('@/pages/user/contents/UserDashboard')
)
const AdminMapLayout = React.lazy(
  () => import('@/pages/admin/map4admin/AdminMapLayout')
)
const IntermentSetup = React.lazy(
...
const AdminIntermentDeceasedPage = React.lazy(
  () => import('@/pages/admin/interment/deceased-records/deceased')
)
const AdminIntermentLotOwnersPage = React.lazy(
  () => import('@/pages/admin/interment/lot-owners/lot-owners')
)
const AdminIntermentCustomerPage = React.lazy(
  () => import('./pages/admin/interment/customer/CustomersLayout')
)
          ...
          <Routes>
            ...
            >
              ...
              <Route element={<IntermentSetup />} path='interment-setup'>
                <Route
                  element={<AdminIntermentCustomerPage />}
                  path='customers'
                />
                <Route
                  element={<AdminIntermentLotOwnersPage />}
                  path='lot-owners'
                />
                <Route
                  element={<AdminIntermentDeceasedPage />}
