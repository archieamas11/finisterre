...
export const description =
  'An interactive area chart showing customer data for lots'
          ...
          <ResponsiveContainer width='100%' height='100%'>
            <AreaChart data={filteredData}>
              <defs>
                ...
                >
                  <stop
                    stopColor='var(--color-serenityLawn)'
                    stopOpacity={1.0}
                    offset='5%'
                  />
                  <stop
                ...
                >
                  <stop
                    stopColor='var(--color-columbarium)'
                    stopOpacity={0.8}
                    offset='5%'
                  />
                  <stop
                ...
                >
                  <stop
                    stopColor='var(--color-memorialChambers)'
                    stopOpacity={0.8}
                    offset='5%'
                  />
                  <stop
              ...
              />
              <Area
                stroke='var(--color-serenityLawn)'
                fill='url(#fillSerenityLawn)'
                dataKey='serenityLawn'
                type='natural'
                stackId='a'
              />
              <Area
                stroke='var(--color-columbarium)'
                fill='url(#fillColumbarium)'
                dataKey='columbarium'
                type='natural'
                stackId='a'
              />
              <Area
                stroke='var(--color-memorialChambers)'
                fill='url(#fillMemorialChambers)'
                dataKey='memorialChambers'
                type='natural'
                stackId='a'
              />
            </AreaChart>
