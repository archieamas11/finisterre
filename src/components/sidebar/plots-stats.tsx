  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Serenity Lawn, Columbarium, and Memorial Chambers (Jan - Jun 2025)
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer config={chartConfig}>
          ...
          >
            ...
            <Area
              dataKey='memorial'
              type='natural'
              fill='var(--color-memorial)'
              fillOpacity={0.1}
              stroke='var(--color-memorial)'
              stackId='a'
            />{' '}
            <Area
              dataKey='columbarium'
            ...
            <Area
              dataKey='serenity'
              type='natural'
              fill='var(--color-serenity)'
              fillOpacity={0.4}
              stroke='var(--color-serenity)'
              stackId='a'
            />
          </AreaChart>
        </ChartContainer>
