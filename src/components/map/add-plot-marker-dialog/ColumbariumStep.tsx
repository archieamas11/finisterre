...
import {
  ColumbariumSchema,
  type ColumbariumFormData
} from '@/schema/plot.scheme'
...
export function ColumbariumStep({
  coordinates,
  onBack,
  onCancel,
  onDone
}: ColumbariumStepProps) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4'>
        ...
        <div className='flex justify-end gap-2'>
          ...
          <Button
            ...
            variant='outline'
            onClick={onCancel}
            disabled={columbarium.isPending}
          >
            Cancel
          </Button>
          <Button
            type='submit'
            disabled={columbarium.isPending || !coordinates}
          >
