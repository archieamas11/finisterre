...
export default function EditMarkerInstructions({
  isVisible,
  step
}: EditMarkerInstructionsProps) {
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          aria-modal='true'
          aria-label={
            step === 'select' ? 'Select marker to edit' : 'Edit marker position'
          }
        >
          <Card
            className={cn(
              ...
              {step === 'select' ? (
                <>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Click on any marker to select it for editing.
                  </p>
                ...
                <>
                  ...
                  <div className='bg-muted/50 mx-auto flex w-full flex-col gap-2 rounded-lg px-4 py-3 text-xs leading-tight'>
                    ...
                    <div className='flex items-center justify-center gap-2'>
                      <kbd className='bg-primary text-primary-foreground rounded-sm px-1.5 py-0.5 font-mono text-xs'>
                        Esc
                      </kbd>
