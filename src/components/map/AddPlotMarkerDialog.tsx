...
export default function AddPlotMarkerDialog({
  open,
  onOpenChange,
  coordinates,
  onDoneAdd,
  onCancelAdd
}: AddPlotMarkerDialogProps) {
      ...
      <Dialog open={open} onOpenChange={onDialogOpenChange}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Choose the type of plot marker to add.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogHeader>
            <DialogTitle>
              {selectedMarkerType === 'Serenity Lawn' &&
                'Add Serenity Lawn Plot'}
              {selectedMarkerType === 'Memorial Chambers' &&
                'Add Memorial Chambers'}
              {selectedMarkerType === 'Columbarium' && 'Add Columbarium'}
              {!selectedMarkerType && 'Select Marker Type First'}
            </DialogTitle>
            <DialogDescription>
              {selectedMarkerType
                ? 'Provide the required details then save the plot.'
                : 'Go back and choose a marker type to proceed.'}
            </DialogDescription>
          </DialogHeader>
          {selectedMarkerType === 'Serenity Lawn' && (
            <SerenityLawnStep
