...
export default function LandingLayout() {
  ...
  return (
    <div className="bg-background flex min-h-full flex-col">
      <nav
        className={[
          "text-background dark:text-accent-foreground fixed top-2 right-0 left-0 z-30 mx-auto flex w-[80vw] max-w-6xl items-center justify-between rounded-xl px-6 py-4 sm:w-[90vw] sm:px-8",
          scrolled
