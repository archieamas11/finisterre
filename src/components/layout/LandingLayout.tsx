...
export default function LandingLayout() {
  ...
  return (
    <div className='bg-background flex min-h-screen flex-col'>
      <header
        className={cn(
          'fixed top-2 right-0 left-0 z-50 mx-auto flex max-w-6xl items-center justify-between rounded-xl px-4 py-2 sm:px-6',
          'w-[85vw] sm:w-[90vw] md:w-[80vw]',
          {
            'border-border bg-background/80 text-foreground shadow-lg backdrop-blur-lg':
              scrolled,
      ...
      >
        <Link
          to='/'
          className='focus:ring-primary flex items-center gap-2 rounded-md font-bold focus:ring-2 focus:ring-offset-2 focus:outline-none'
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
          ...
          <Button
            asChild
            type='button'
            className='hover:bg-primary/10 rounded-full border transition-colors'
            aria-label='Login'
            variant='secondary'
          >
