    ...
    <div className="relative">
      <div className="relative">
        <Input
          ...
          value={value || ""}
          className={cn(error && "border-destructive focus-visible:ring-destructive", className, "pr-8")}
        />
        <Popover onOpenChange={setCalendarOpen} open={calendarOpen}>
          ...
          <PopoverContent className="w-auto overflow-hidden p-0" alignOffset={-8} sideOffset={10} align="end">
            <Calendar
              onSelect={(date) => {
                setSelectedDate(date);
                setMonth(date);
