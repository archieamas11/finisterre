...
import { type ControllerProps, type FieldValues, useFormContext, type FieldPath, FormProvider, useFormState, Controller } from "react-hook-form";
...
function FormControl({ ...props }: React.ComponentProps<typeof Slot>) {
  ...
  return (
    <Slot aria-describedby={!error ? formDescriptionId : `${formDescriptionId} ${formMessageId}`} data-slot="form-control" aria-invalid={!!error} id={formItemId} {...props} />
  );
}
