  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    ...
    variants: {
      ...
      variant: {
        ...
        gradient:
          'relative overflow-hidden bg-gradient-to-r from-[oklch(18.583%_0.01131_260.674)] to-[oklch(45%_0.15_280)] text-white shadow-lg hover:shadow-xl hover:shadow-[oklch(18.583%_0.01131_260.674)_0_0_20px_5px] transition-all duration-300 transform hover:-translate-y-0.5 hover:scale-[1.02] before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/20 before:to-transparent before:opacity-70 before:pointer-events-none after:absolute after:inset-0 after:bg-gradient-to-t after:from-black/20 after:to-transparent after:pointer-events-none'
      }
    }
  }
)
