...
const testimonials = [
  {
    ...
    description: (
      <p>
        ...
        <Highlight>The lifetime memorial rights</Highlight> gave us peace of
        mind that our legacy would be preserved. The grounds are always
        immaculate and filled with serene beauty.
      </p>
    )
  },
  {
    ...
    description: (
      <p>
        I've worked with many cemeteries, but this one stands apart.{' '}
        <Highlight>Their complete burial services</Highlight> and modern
        facilities make every arrangement dignified and seamless. Families
  ...
  },
  {
    ...
    description: (
      <p>
        The <Highlight>digital map feature</Highlight> has transformed how our
        community connects with its history. Finding relatives and learning
        about local heritage has never been easier. It's wonderful to see
        technology used so meaningfully.
      </p>
    )
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>The respect and honor shown</Highlight> to those who served
        is evident in every detail. Our members feel proud knowing this is their
        final resting place.
      </p>
    )
  },
  {
    ...
    description: (
      <p>
        As someone who appreciates horticulture, I'm continually impressed by
        the grounds. <Highlight>The serene gardens</Highlight> are thoughtfully
        designed and maintained with exceptional care. It's a place of
        remembrance and beauty.
      </p>
    )
  },
  {
    ...
    description: (
      <p>
        I often recommend this memorial park to clients.{' '}
        <Highlight>The growing value of the property</Highlight> makes it a
        sound investment for future generations. It's rare to find such a
        combination of financial and emotional value.
      </p>
    )
  }
]
